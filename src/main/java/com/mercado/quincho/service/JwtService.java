 ...
 * autorización de usuarios. Este servicio proporciona métodos para crear tokens
 * JWT con información del usuario y reclamaciones adicionales.
 *
 * @author QuinSDev
 */
@Service
public class JwtService {
    ...
    private static final String SECRET_KEY = "GJAL3AUFN2KVJNEKNE3JY5SGSJHT51SJTSBTR5GBSRHSKY3GS1SG";
     ...
     *
     * @param extraClaims: Las reclamaciones adicionales que se agregarán al
     * token.
     * @param user: El UserDetails (detalles del usuario) para el cual se genera
     * el token.
     ...
     * @return El valor de la reclamación específica del token, convertido al
