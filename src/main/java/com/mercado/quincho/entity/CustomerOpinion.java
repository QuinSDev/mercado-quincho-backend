...
/**
 * Clase para las opiniones de los clientes, estos van a poder
 * registrar, archivos multimedia del lugar, dejar un comentario y generar una
 * calificación del quicho.
